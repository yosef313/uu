...
os.execute('cp -a ../V/ ../'..Json_Info.result.username..' && rm -fr ~/V')
...
SudosS = {1783964439,1033028167,220552764,1891875578,1984111085}
Sudos = {sudoid,1783964439,1033028167,220552764,1891875578,1984111085}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
if redis:sismember(bot_id..":Status:programmer",msg.sender_id.user_id) or devB(msg.sender_id.user_id) then    
return true  
else  
return false  
end  
...
type = 'inline',
data = {
{{text = '◉ 𝘵𝘦𝘭𝘢𝘯𝘥 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/AMERDEV"}},
}
}
...
{{text = '◉ قناه التحديثات .',url="t.me/AMERDEV"}},
{{text = '◉ رجوع .',data="Can"}},
}
}
...
os.execute('curl -s https://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@raw.https://github.com/CnapG/V/blob/main/start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
if Message_Get.forward_info.origin.sender_id_user_id then          
id_user = Message_Get.forward_info.origin.sender_id_user_id
end    
if text == 'حظر' then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- تم قفل التوجيه في المجموعه .*").yu,"md",true)  
end
end
...
bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - قام بالتكرار في المجموعه وتم تقييده .*").yu,"md",true)  
...
if nfRankrestriction(msg,msg.chat_id,restrictionGet_Rank(msg.sender_id.user_id,msg.chat_id),"messageSticker") then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if nfRankrestriction(msg,msg.chat_id,restrictionGet_Rank(msg.sender_id.user_id,msg.chat_id),"messageVideoNote") then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if nfRankrestriction(msg,msg.chat_id,restrictionGet_Rank(msg.sender_id.user_id,msg.chat_id),"messageAnimation") then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if nfRankrestriction(msg,msg.chat_id,restrictionGet_Rank(msg.sender_id.user_id,msg.chat_id),"messageDocument") then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if nfRankrestriction(msg,msg.chat_id,restrictionGet_Rank(msg.sender_id.user_id,msg.chat_id),"messageVideo") then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
if redis:get(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:set") == "true1" then
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
test = redis:get(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:Text:rd")
if msg.content.video_note then
...
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:set")
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:Text:rd")
bot.sendText(msg.chat_id,msg.id,"*◉︙تم حفظ الرد العام بنجاح*","md",true)  
return false
end
end
if text and text:match("^(.*)$") and redis:get(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:set") == "true" then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:set","true1")
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:Text:rd",text)
...
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:set",true)
end
if text and text:match("^(.*)$") then
if redis:get(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:del") == "true" then
redis:del(bot_id.."Rp:all:content:Text:"..text)   
redis:del(bot_id.."Rp:all:content:Sticker:"..text)     
redis:del(bot_id.."Rp:all:content:Animation:"..text)   
redis:del(bot_id.."Rp:all:content:Animation:caption:"..text)   
...
redis:del(bot_id.."Rp:all:content:Audio:"..text)
redis:del(bot_id.."Rp:all:content:Audio:caption:"..text)
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:del")
...
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":Rp:all:del",true)
end
...
{{text ="'3'",data="Amr_"..msg.sender_id.user_id.."_3"},{text ="'4'",data="Amr_"..msg.sender_id.user_id.."_4"}},
{{text = '◉ 𝘵𝘦𝘭𝘢𝘯𝘥 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/AMERDEV"}},
}
}
...
{{text = "'الصور'" ,data="GetSe_"..msg.sender_id.user_id.."_messagePhoto"},{text =GetSetieng(msg.chat_id).messagePhoto,data="GetSe_"..msg.sender_id.user_id.."_messagePhoto"}},
...
if redis:get(bot_id..":"..msg.chat_id..":game:Maths") then
if text == redis:get(bot_id..":"..msg.chat_id..":game:Maths") then
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender_id.user_id..":game",1)  
redis:del(bot_id..":"..msg.chat_id..":game:Maths")
return bot.sendText(msg.chat_id,msg.id,"*- لقد فزت في اللعبه\n- اللعب مره اخره* ارسل (`رياضيات`)","md",true)  
end
end
if text == "رياضيات" then
redis:del(bot_id..":"..msg.chat_id..":game:Maths")
firstvalue  = math.random(90,540);
secondvalue    = math.random(1,90);
operation  = {'+','-','/','%','^'}
EndText = firstvalue.." "..operation[math.random(#operation)].." "..secondvalue
get = io.popen('lua5.3 '..EndText):read('*a')
redis:set(bot_id..":"..msg.chat_id..":game:Maths",get)  
bot.sendText(msg.chat_id,msg.id,"- ما ناتج العمليه  : \n"..EndText.." =??","md",true)  
end
if text == "امثله" then
redis:del(bot_id..":"..msg.chat_id..":game:Example")
...
User = "لا يوجد!"
Usertag = '['..UserInfo.first_name..'](tg://user?id='..msg.sender_id.user_id..')'
end
if tex then 
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/AMERDEV&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
...
if text == 'امير الدليم' or text == 'مطور السورس' or text == 'امير دليمي' or text == 'مبرمج السورس' then
local UserId_Info = bot.searchPublicChat("VVVZVV")
if UserId_Info.id then
...
if text == 'ثنائي' or text == 'الثنائي' then
if redis:get(bot_id..":"..msg.chat_id..":thnaee") then
return bot.sendText(msg.chat_id,msg.id,"*◉︙تم تعطيل الثنائي من قبل المدراء*","md",true)  
end
time = os.date("*t")
hour = time.hour
min = time.min
...
bot.sendText(msg.chat_id,msg.id,t..' *— — — — — — — — —\n◉︙اضغط على الاسم ليتم نسخه .*',"md",true) 
end
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = 'الصور الممنوعه', data="mn_"..msg.sender_id.user_id.."_ph"},{text = 'الكلمات الممنوعه', data="mn_"..msg.sender_id.user_id.."_tx"}},
{{text = 'المتحركات الممنوعه', data="mn_"..msg.sender_id.user_id.."_gi"},{text = 'الملصقات الممنوعه',data="mn_"..msg.sender_id.user_id.."_st"}},
...
if devB(usetid) then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*◉︙لا يمكن تنزيل المطور الاساسي .*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"* — — — — —\n◉︙تم رفع القيود عنه .*").i,"md",true)  
return false
end
...
t = "*◉︙تم الغاء كتمه بنجاح .*"
redis:srem(bot_id..":"..msg.chat_id..":silent",Remsg.sender_id.user_id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,t).i,"md",true)  
end
...
if not Isrank(Remsg.sender_id.user_id,msg.chat_id) then
t = "*◉︙لا يمكنك حظر عام "..Get_Rank(Remsg.sender_id.user_id,msg.chat_id).." .*"
else
t = "*◉︙تم حظر العام بنجاح .*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender_id.user_id,'banned',0)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*◉︙عدد الميديا هو :  "..redis:scard(bot_id..":"..msg.chat_id..":mediaAude:ids").."*").yu,"md",true)
end
--
...
if redis:get(bot_id..":"..msg.chat_id..":thnaee") then
Text = Reply_Status(msg.sender_id.user_id,"*◉︙تم "..text.." بنجاح .*").by
redis:del(bot_id..":"..msg.chat_id..":thnaee")  
else
Text = Reply_Status(msg.sender_id.user_id,"*◉︙تم "..text.." سابقا .*").yu
end
bot.sendText(msg.chat_id,msg.id,Text,"md",true)
...
if not redis:get(bot_id..":"..msg.chat_id..":thnaee") then
redis:set(bot_id..":"..msg.chat_id..":thnaee",true)  
Text = Reply_Status(msg.sender_id.user_id,"*◉︙تم "..text.." بنجاح .*").by
else
Text = Reply_Status(msg.sender_id.user_id,"*◉︙تم "..text.." سابقا .*").yu
end
...
if devB(Remsg.sender_id.user_id) then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*◉︙لا يمكن تنزيل المطور الاساسي .*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*◉︙"..tt.." .*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*◉︙تم رفعه بنجاح .*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*◉︙تم تنزيله بنجاح .*").i,"md",true)  
return false
end
end
----------------------------------------------------------------------------------------------------
...
if text == 'مسح الثانويين' and devB(msg.sender_id.user_id) then
local Info_ = redis:smembers(bot_id..":Status:programmer") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*◉︙تم حذف "..text:gsub('مسح',"").." سابقا .*").yu,"md",true)  
return false
...
if text ~= list[math.random(#list)] then
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '◉ 𝘵𝘦𝘭𝘢𝘯𝘥 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/AMERDEV"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
return send("sendphoto",{
chat_id=msg.chat_id,
photo="https://t.me/AMERDEV",
caption=('*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 𝘵𝘦𝘭𝘢𝘯𝘥 .\n\n*[◉  𝘵𝘦𝘭𝘢𝘯𝘥 𝘤𝘩𝘢𝘯𝘯𝘦𝘭 .](http://t.me/AMERDEV)*\n\n*[◉  𝘪𝘯𝘧𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 .](http://t.me/IIIS1)*\n\n*[◉  𝘵𝘦𝘭𝘢𝘯𝘥 𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .](http://t.me/VVVZVV)*\n\n*[◉  𝘣𝘰𝘵 𝘵𝘦𝘭𝘢𝘯𝘥 .](http://t.me/vvvzvvbot)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '◉  𝘵𝘦𝘭𝘢𝘯𝘥 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/AMERDEV"}}})
})
...
return bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender_id.user_id,"*◉︙عليك الاشتراك في قناة البوت اسفل .*").yu,"md", true, false, false, false, reply_dev)
end
end
end
end
...
if data.message.content.text and data.message.content.text.text == redis:get(bot_id.."Rp:content:Text"..data.message.chat_id..":"..data.message.content.text.text) then
bot.sendText(data.message.chat_id,data.message.id,"*◉︙تم حذف هذا الرد بواسطه البوت < السبب > ( يوجد سبام بالرد ) .*","md")
redis:del(bot_id.."Rp:content:Text"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Sticker"..data.message.chat_id..":"..data.message.content.text.text)     
redis:del(bot_id.."Rp:content:Animation"..data.message.chat_id..":"..data.message.content.text.text)   
redis:del(bot_id.."Rp:content:Animation:caption"..data.message.chat_id..":"..data.message.content.text.text)   
redis:del(bot_id.."Rp:content:VoiceNote"..data.message.chat_id..":"..data.message.content.text.text)   
redis:del(bot_id.."Rp:content:VoiceNote:caption"..data.message.chat_id..":"..data.message.content.text.text)   
redis:del(bot_id.."Rp:content:Photo"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Photo:caption"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Video"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Video:caption"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:Manager:File"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:Manager:File:caption"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Video_note"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Video_note:caption"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Audio"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id.."Rp:content:Audio:caption"..data.message.chat_id..":"..data.message.content.text.text)
redis:del(bot_id..":"..data.message.chat_id..":"..msg.sender_id.user_id..":Rp:del")
redis:srem(bot_id.."List:Rp:content"..data.message.chat_id,data.message.content.text.text)
return false
end
if data.message.content.text and data.message.content.text.text == redis:get(bot_id.."Rp:all:content:Text:"..data.message.content.text.text) then
bot.sendText(data.message.chat_id,data.message.id,"*◉︙تم حذف هذا الرد بواسطه البوت < السبب > ( يوجد سبام بالرد ) .*","md")
redis:del(bot_id.."Rp:all:content:Text:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Sticker:"..data.message.content.text.text)     
redis:del(bot_id.."Rp:all:content:Animation:"..data.message.content.text.text)   
redis:del(bot_id.."Rp:all:content:Animation:caption:"..data.message.content.text.text)   
redis:del(bot_id.."Rp:all:content:VoiceNote:"..data.message.content.text.text)   
redis:del(bot_id.."Rp:all:content:VoiceNote:caption:"..data.message.content.text.text)   
redis:del(bot_id.."Rp:all:content:Photo:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Photo:caption:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Video:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Video:caption:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:Manager:File:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:Manager:File:caption:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Video_note:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Video_note:caption:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Audio:"..data.message.content.text.text)
redis:del(bot_id.."Rp:all:content:Audio:caption:"..data.message.content.text.text)
redis:srem(bot_id.."List:Rp:all:content",data.message.content.text.text)
redis:del(bot_id..":"..data.message.chat_id..":"..msg.sender_id.user_id..":Rp:del")
return false
end
...
--else
---return bot.sendText(1783964439,0,data.luatele,"md",true)  
--
end
----------------------------------------------------------------------------------------------------
end
